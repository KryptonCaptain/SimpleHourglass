 ...
 */
package vazkii.s_hg.common.lib;
...
public final class LibMisc {
	...
	// Proxy Constants
	public static final String PROXY_COMMON = "vazkii.s_hg.common.core.proxy.CommonProxy";
	public static final String PROXY_CLIENT = "vazkii.s_hg.client.core.proxy.ClientProxy";
	public static final String GUI_FACTORY = "vazkii.s_hg.client.core.proxy.GuiFactory";
